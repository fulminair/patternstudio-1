...
const createInstance = (
  index: number,
  overrides: HofenbitzerWideBasicSleevePatternInstance["overrides"] = {},
): HofenbitzerWideBasicSleevePatternInstance => ({
  id: createId(),
  name: `Draft ${index + 1}`,
...
const defaultUi: HofenbitzerWideBasicSleeveProjectUiState = {
...
const measurementKeys: Array<keyof HofenbitzerWideBasicSleeveBaseMeasurements> = [
  "AhH",
  "AhHEase",
  "fAh",
  "bAh",
...
export const mergeEffectiveMeasurements = (
  ...
  instance: HofenbitzerWideBasicSleevePatternInstance,
): HofenbitzerWideBasicSleeveEffectiveMeasurements => {
  const merged: HofenbitzerWideBasicSleeveBaseMeasurements = {
    ...base,
    ...instance.overrides,
  };
...
export type HofenbitzerWideBasicSleeveStoreState = HofenbitzerWideBasicSleeveProjectState & {
  ...
  setOverride: (
    id: string,
    key: keyof HofenbitzerWideBasicSleeveBaseMeasurements,
    value: number | null | undefined,
  ) => void;
  resetOverrides: (id: string) => void;
  setUiToggle: (key: UiBooleanKey, value: boolean) => void;
  setLineStrokeWidth: (value: number) => void;
  hydrateFromProject: (next: HofenbitzerWideBasicSleeveProjectState) => void;
  getEffectiveMeasurements: (
    id: string,
  ) => HofenbitzerWideBasicSleeveEffectiveMeasurements | null;
  getSceneForInstance: (id: string) => PatternScene | null;
};

export const useHofenbitzerWideBasicSleeveStore = create<HofenbitzerWideBasicSleeveStoreState>(
  (set, get) => ({
    base: defaultBase,
    ...
    hydrateFromProject: (next) => {
      set(() => {
        ...
        const normalizedBase: HofenbitzerWideBasicSleeveBaseMeasurements = {
          ...defaultBase,
        };
...
export const selectProjectState = (
  state: HofenbitzerWideBasicSleeveStoreState,
): HofenbitzerWideBasicSleeveProjectState => ({
  base: state.base,
