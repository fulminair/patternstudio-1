...
import type { HofenbitzerTightBasicSleevePatternInstance } from "@/patterns/hofenbitzerTightBasicSleeve/types";
...
function DraftListItem({
  ...
  draft: HofenbitzerTightBasicSleevePatternInstance;
  selected: boolean;
}) {
...
export function HofenbitzerTightBasicSleeveDraftsPanel() {
  const drafts = useHofenbitzerTightBasicSleeveStore((state) => state.instances);
  const selectedDraftId = useHofenbitzerTightBasicSleeveStore((state) => state.ui.selectedInstanceId);
  const addDuplicate = useHofenbitzerTightBasicSleeveStore((state) => state.addDuplicate);
