...
import type { PatternInstance } from "@/patterns/types";
...
function DraftListItem({
  ...
  const setInstanceColor = usePatternStore((state) => state.setInstanceColor);
...
export function InstancesPanel() {
  const drafts = usePatternStore((state) => state.instances);
  const selectedDraftId = usePatternStore((state) => state.ui.selectedInstanceId);
