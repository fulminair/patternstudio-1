...
import type { HofenbitzerPatternInstance } from "@/patterns/hofenbitzerBasicSkirt/types";
...
function DraftListItem({
  ...
  draft: HofenbitzerPatternInstance;
  selected: boolean;
}) {
  const setSelectedInstance = useHofenbitzerStore((state) => state.setSelectedInstance);
  const toggleVisible = useHofenbitzerStore((state) => state.toggleVisible);
  const removeInstance = useHofenbitzerStore((state) => state.removeInstance);
  const setInstanceColor = useHofenbitzerStore((state) => state.setInstanceColor);
...
export function HofenbitzerDraftsPanel() {
  const drafts = useHofenbitzerStore((state) => state.instances);
  const selectedDraftId = useHofenbitzerStore((state) => state.ui.selectedInstanceId);
  const addDuplicate = useHofenbitzerStore((state) => state.addDuplicate);
