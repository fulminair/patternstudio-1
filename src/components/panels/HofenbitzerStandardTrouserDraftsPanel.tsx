...
import type { HofenbitzerStandardTrouserPatternInstance } from "@/patterns/hofenbitzerStandardTrouser/types";
...
function DraftListItem({
  ...
  draft: HofenbitzerStandardTrouserPatternInstance;
  selected: boolean;
}) {
  const setSelectedInstance = useHofenbitzerStandardTrouserStore((state) => state.setSelectedInstance);
  const toggleVisible = useHofenbitzerStandardTrouserStore((state) => state.toggleVisible);
  const removeInstance = useHofenbitzerStandardTrouserStore((state) => state.removeInstance);
  const setInstanceColor = useHofenbitzerStandardTrouserStore((state) => state.setInstanceColor);
...
export function HofenbitzerStandardTrouserDraftsPanel() {
  const drafts = useHofenbitzerStandardTrouserStore((state) => state.instances);
  const selectedDraftId = useHofenbitzerStandardTrouserStore((state) => state.ui.selectedInstanceId);
  const addDuplicate = useHofenbitzerStandardTrouserStore((state) => state.addDuplicate);
